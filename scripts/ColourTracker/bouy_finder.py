...
class BouyFinder:
    ...
    def run(self):
        ...
        while True:
            ...
            #cv.Threshold(hue,threshtimes,38,255,cv.CV_THRESH_BINARY)    # do the thresholding (150 seems good for underwater orange)
            cv.AdaptiveThreshold(hue, threshtimes, 255, cv.CV_ADAPTIVE_THRESH_MEAN_C, cv.CV_THRESH_BINARY, 7, 15) #seems to be good for edge detection etc
            x_val = 0
            y_val = 0
            self.pixel_count = 0
            ...
            if self.pixel_count >= 10: # divide by 0 protection / noise removal
            ...
            #print "x = ", self.corr_x, "y = ", self.corr_y, "area = ", self.pixel_count
