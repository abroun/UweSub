...
class HighPrecisionTime
{
    ...
    public: HighPrecisionTime( S32 seconds, S32 nanoSeconds )
        : mSeconds( seconds ), mNanoSeconds( nanoSeconds ) {}
    ...
    //--------------------------------------------------------------------------
    // Creates a HighPrecisiontime from a double value seconds
    public: static HighPrecisionTime ConvertFromSeconds( double seconds );
