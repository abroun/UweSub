...
//-- values for the "usedchannels" argument of the above function (note
//   that different values can be added to use multiple channels)
...
//-- values for the "servono" argument of the above function
     ...
     #define RCSERVO_KONDO_DEFAULT	        (0x10)  //conservative setting for KONDO's servos
     #define RCSERVO_KONDO_KRS786	        (0x11)
     #define RCSERVO_KONDO_KRS788			(0x12)
     #define RCSERVO_KONDO_KRS78X			(0x13)
     #define RCSERVO_HITEC_DEFAULT	        (0x21)  //conservative setting for HITEC's servos
...
RBAPI(bool) rcservo_SetServoType(int channel, unsigned type, unsigned mode);
//-- values for the "type" argument of the above function
     #define RCSERVO_SV_FEEDBACK            (1)     //servo with pulse feedback
     #define RCSERVO_SV_NOFEEDBACK          (2)     //servo without pulse feedback
//-- values for the "mode" argument of the above function (note that
//   different values can be added to use multiple settings)
     #define RCSERVO_FB_SAFEMODE            (0)
     #define RCSERVO_FB_FASTMODE            (1<<0)  //much faster than safe mode but could cause servo's shake
...
RBAPI(bool) rcservo_SetReadFBParams2(int channel, unsigned long resolution, unsigned long offset);
...
//-- values for the "cmd" argument of the above functions
