...
//-- values for the "devs" argument (note that different values can be added to use multiple modules)
...
//-- if the above functions return 0xffffffffL, ERR_Type may be settled as the following number:
...
//-- if the above functions return 0xffff, ERR_Type may be settled as the following number:
//   #define ERROR_I2CFAIL		    (ERR_NOERROR + 610)
//   #define ERROR_I2CWRONGUSAGE    (ERR_NOERROR + 630)
//   #define ERROR_I2CARLOSS        (ERR_NOERROR + 621)
...
//-- if the aboves functions return 0xffff, ERR_Type may be settled as the following number:
//   #define ERROR_I2CFAIL		    (ERR_NOERROR + 610)
//   #define ERROR_I2CWRONGUSAGE    (ERR_NOERROR + 630)
...
//-- if the above function return 0xffff, ERR_Type may be settled as the following number:
//   #define ERROR_I2CWRONGUSAGE    (ERR_NOERROR + 630)
